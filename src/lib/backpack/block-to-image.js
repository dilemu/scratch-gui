...
import ScratchBlocks from 'delightmom-scratch-blocks';
...
export default function (blockId) {
    // Not sure any better way to access the delightmom-scratch-blocks workspace than this...
    ...
    return new Promise(resolve => {
        setTimeout(() => {
            ...
            computedStyleToInlineStyle(svg, {
                ...
                // Specifically properties that are set from CSS in delightmom-scratch-blocks
