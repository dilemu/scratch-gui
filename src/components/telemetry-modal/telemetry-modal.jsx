...
const messages = defineMessages({
    label: {
        ...
        defaultMessage: 'Report statistics to improve DBit+',
        description: 'DBit+ telemetry modal label - for accessibility'
    },
    bodyText1: {
        defaultMessage: 'The DBit+ Team is always looking to better understand how DBit+ is used around the ' +
            'world. To help support this effort, you can allow DBit+ to automatically send usage information to ' +
            'the DBit+ Team.',
    ...
    privacyPolicyLink: {
        ...
        description: 'Link to the DBit+ privacy policy',
        id: 'gui.telemetryOptIn.privacyPolicyLink'
    },
    optInText: {
        defaultMessage: 'Share my usage data with the DBit+ Team',
    ...
    optOutText: {
        defaultMessage: 'Do not share my usage data with the DBit+ Team',
        description: 'Text for telemetry modal opt-in button',
                    ...
                    <p><FormattedMessage
                        ...
                        values={{
                            privacyPolicyLink: (<a
                                ...
                                href="https://DBit+.cc/privacy_policy/"
